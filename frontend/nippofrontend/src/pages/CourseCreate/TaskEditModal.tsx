...
import { Box, Checkbox, TextField, Typography, Button, Container, Modal } from "@mui/material";
...
export const TaskEditModal = ({isOpen, handleClose, questionId}: TaskProps) => {
  ...
  <Container>
    ...
    <Box
      ...
      <Button
        ...
        onClick={() => {
          handleClose();
          setTask({id: -1, question: "", answers: [] as Answer[], type: "Written" });
        }}>
        Отмена
      </Button>
      <Button
